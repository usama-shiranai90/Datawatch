    ...
    <nav x-data="{ isOpen: false , isMobileOpen:false }" class="bg-dark-600">
      ...
      <div x-show="isMobileOpen"
        ...
        <div class="px-2 py-3 space-y-1 sm:px-3">
          ...
          <a href="#"
             class="text-gray-300 hover:bg-shaddy-500 hover:text-dark-0 block px-3 py-2 rounded-md text-base font-medium">Product
            Submission</a>

          <a href="#"
             class="text-gray-300 hover:bg-shaddy-500 hover:text-dark-0 block px-3 py-2 rounded-md text-base font-medium">Request
            Page</a>

          <a href="#"
             class="text-gray-300 hover:bg-shaddy-500 hover:text-dark-0 block px-3 py-2 rounded-md text-base font-medium">Server
            Pages</a>
        ...
        <div class="grid grid-cols-1 gap-4 items-start lg:grid-cols-3 lg:gap-8">
                  ...
                  <div class="sm:flex sm:items-center sm:justify-between">
                    <div class="sm:flex sm:space-x-5">
                      ...
                      <div class="mt-4 text-center sm:mt-0 sm:pt-1 sm:text-left">
                        ...
                        <p class="text-xl font-bold text-dark-600 sm:text-2xl">Akash Noor</p>
                        <p class="text-sm font-medium text-dark-500">Seller </p>
                      </div>
                    </div>
                ...
                <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                  <div class="relative bg-white pt-5 px-4 pb-12 sm:pt-6 sm:px-6 shadow rounded-lg overflow-hidden">
                    <dt>
                      ...
                      <p class="ml-16 text-sm font-medium text-gray-500 truncate">Current Income</p>
                    </dt>
                    <dd class="ml-16 pb-6 flex items-baseline sm:pb-7">
                      <p class="text-2xl font-semibold text-gray-900">71,897</p>

                      <div class="absolute bottom-0 inset-x-0 bg-gray-50 px-4 py-4 sm:px-6">
                        <div class="text-sm font-medium text-dark-600 hover:text-dark-800">Salary on going stats</div>
                      </div>
                    </dd>
                  </div>
                  ...
                  <div class="relative bg-white pt-5 px-4 pb-12 sm:pt-6 sm:px-6 shadow rounded-lg overflow-hidden">
                    <dt>
                      ...
                      <p class="ml-16 text-sm font-medium text-gray-500 truncate">Investment</p>
                    </dt>
                    <dd class="ml-16 pb-6 flex items-baseline sm:pb-7">
                      <p class="text-2xl font-semibold text-gray-900">3,199</p>

                      <div class="absolute bottom-0 inset-x-0 bg-gray-50 px-4 py-4 sm:px-6">
                        <div class="text-sm font-medium text-dark-600 hover:text-dark-800">Overall product Investment
                        </div>
                      </div>
                    </dd>
                  </div>
                  ...
                  <div class="relative bg-white pt-5 px-4 pb-12 sm:pt-6 sm:px-6 shadow rounded-lg overflow-hidden">
                    ...
                    <dd class="ml-16 pb-6 flex items-baseline sm:pb-7">
                      ...
                      <div class="absolute bottom-0 inset-x-0 bg-gray-50 px-4 py-4 sm:px-6">
                        <div class="text-sm font-medium text-dark-600 hover:text-dark-800">Product sales on going
                          stats
                        </div>
                      </div>
                    </dd>
          ...
          <div class="grid grid-cols-1 gap-4">
            ...
            <section aria-labelledby="monthly-sales">
              <div class="rounded-lg bg-white overflow-hidden shadow">
                <div class="p-6">
                  <h2 class="text-lg font-medium text-dark-600" id="monthly-sales">Product Summary</h2>
                  <div class="flow-root mt-6">
                    <ul role="list" class="-my-5 divide-y divide-gray-200">
                      <li class="py-3 flex items-center space-x-4">
                        <div class="flex-1 min-w-0">
                          <p class="text-base font-medium text-dark-600 truncate">Product xyz</p>
                        </div>
                        <span class="flex-1 shadow-sm py-1 text-base leading-5 font-medium text-dark-600 bg-white">
                              23/Feb/2022
                            </span>
                        <div class="flex-shrink-0 w-3.5 h-3.5 rounded-full bg-red-600" aria-hidden="true"></div>
                      </li>
                      <li class="py-3 flex items-center space-x-4">
                        <div class="flex-1 min-w-0">
                          <p class="text-base font-medium text-dark-600 truncate">Product abc</p>
                        </div>
                        <span class="flex-1 shadow-sm py-1 text-base leading-5 font-medium text-dark-600 bg-white">
                              23/Feb/2022
                            </span>
                        <div class="flex-shrink-0 w-3.5 h-3.5 rounded-full bg-green-600" aria-hidden="true"></div>
                      </li>
                      <li class="py-3 flex items-center space-x-4">
                        <div class="flex-1 min-w-0">
                          <p class="text-base font-medium text-dark-600 truncate">Product abc</p>
                  ...
                  <div class="mt-6">
                    <a href="#" class="block w-full flex items-center justify-center rounded-md border border-transparent px-5 py-3 border border-gray-300 shadow-sm
