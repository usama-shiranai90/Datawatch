        ...
        <stop offset="1" style="stop-color:#00527B"></stop>
              ...
              <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                  ...
                  <a href="SalesSummary" class="bg-dark-300 text-dark-0 px-3 py-2 rounded-md text-sm font-medium">Sales
                    Summary</a>
  ...
  <main class="-mt-32">
              ...
              <div class="bg-white p-6">
                ...
                <div class="flex items-center justify-center w-full">
                  <div class="w-full md:w-1/4">
                    <label for="summary-month" class="block text-sm font-medium text-dark-600">Month</label>
                    <select id="summary-month" name="month" class="block border w-full border-gray-300 rounded-md px-4 py-2 text-base text-dark-500
    ...
    display: contents;">
            ...
            <div class="px-4 sm:px-6 lg:px-8">
              <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                  <h1 class="text-xl font-semibold text-dark-800">User List</h1>
                  <p class="mt-2 text-sm text-dark-600">Your team monthly <strong class="font-semibold text-dark-600">Sales</strong>.
                    Select any user to view record.</p>
                </div>
              ...
              <div class="-mx-4 mt-5 ring-1 ring-gray-300 sm:-mx-6 md:mx-0 md:rounded-lg">
                <table
                  ...
                  <tr class="text-center text-sm text-dark-0">
                    ...
                    <th scope="col" class="font-normal px-3 py-3.5">Salary</th>
                  ...
                  <tr class="text-center text-sm font-medium text-dark-600">
                    <td class="relative py-4 pl-4 sm:px-4 pr-3 text-sm">
                      <h4 class="font-semibold italic">Akash Noor</h4>
                      <div class="mt-1 flex flex-col text-dark-300 sm:block lg:hidden">
                        <span class="leading-tight tracking-tight"> <label class="text-base">9</label> Achieve |</span>
                        <span class="sm:inline lg:hidden leading-tight tracking-tight"> <label
                            class="text-base">1999 </label> Price |</span>
                        <span class="sm:inline lg:hidden leading-tight tracking-tight"> <label
                            class="text-base">240 </label> Invest</span>

                      </div>
                    </td>

                    <td class="hidden px-3 py-3.5 text-sm text-gray-500 lg:table-cell">9</td>
                    <td class="hidden px-3 py-3.5 text-sm text-gray-500 lg:table-cell">1999</td>
                    <td class="hidden px-3 py-3.5 text-sm text-gray-500 lg:table-cell">240</td>
                    <td class="px-3 py-3.5 text-sm text-gray-500">
                      <div class="sm:hidden">600</div>
                      <div class="hidden sm:block">600</div>
                    </td>
                    <td class="relative py-3.5 pl-3 pr-4 sm:pr-6 text-right text-sm font-medium ">
                      <button type="button"
                              class="inline-flex items-center rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium leading-4 text-dark-600 transition duration-300 ease-linear shadow-sm hover:bg-gray-50 hover:bg-dark-500 hover:text-dark-0">
                        Select<span class="sr-only">, Hobby</span></button>
                    </td>
            ...
            <div class="px-4 sm:px-6 lg:px-8">
              <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                  <h1 class="text-xl font-semibold text-dark-800">Selected User ( Akash Noor )</h1>
                  <p class="mt-2 text-sm text-dark-600">The <strong class="font-semibold text-dark-600">sales
                      summary</strong>.
                    for product list and other necessary information are enlisted below.</p>
                </div>
